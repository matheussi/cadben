<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="cadben.www.login" %>
<!DOCTYPE html>
<html lang="pt">
  <head runat="server">
    <title>CADBEN - Entrar</title>
...
<form class="form login-form" runat="server" id="form1">
    <div class="navbar navbar-fixed-top">
      ...
      <a class="brand" target="_blank" href="http://www.clubeazul.org.br">
          <!--<img src="Images/clubeazul.png" alt="" height='70'>-->
      </a>
    </div>
    </div>
